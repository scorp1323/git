 ...
 // МЕНЯЕМ ТУТ!!!
   ...
   $fone_namber_2 = $_POST['fone_namber_2'];
    ...
    mysql_query("SET NAMES 'utf8'",$db);
     ...
     // МЕНЯЕМ ТУТ - 2 РАЗА!!!
    $result = mysql_query ("INSERT INTO ".$db_table." (first_name,last_name,middle_name,fone_namber_1,fone_namber_2)



     VALUES ('$first_name','$last_name','$middle_name','$fone_namber_1','$fone_namber_2')");
