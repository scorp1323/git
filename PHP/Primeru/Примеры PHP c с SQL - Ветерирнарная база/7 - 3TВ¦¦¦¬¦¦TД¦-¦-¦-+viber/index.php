 ...
 // МЕНЯЕМ ТУТ!!!
   ...
   $fone_namber_3 = $_POST['fone_namber_3'];
    ...
    mysql_query("SET NAMES 'utf8'",$db);
     ...
     // МЕНЯЕМ ТУТ - 2 РАЗА!!!
    $result = mysql_query ("INSERT INTO ".$db_table." (first_name,last_name,middle_name,fone_namber_1,fone_namber_2,fone_namber_3,viber_namber)



     VALUES ('$first_name','$last_name','$middle_name','$fone_namber_1','$fone_namber_2','$fone_namber_3','$viber_namber')");
